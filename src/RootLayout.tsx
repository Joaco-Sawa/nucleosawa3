...
import desafiosIcon from 'figma:asset/4a15d0bd599bae1cbcac1fa0399a4fb2828475b7.png';
import muroIcon from 'figma:asset/7179fbd1cf901f8eea694e734ad1384f3443cc43.png';
      ...
      >
        ...
        <nav className="flex-1 p-4 overflow-y-auto min-h-0">
          <div className="space-y-1">
            ...
            <button className="flex items-center transition-all duration-200 group text-slate-600 hover:text-slate-900 hover:bg-[#FF8000]/5 w-full gap-3 px-4 py-3 rounded-xl">
      ...
      >
        <div className="grid grid-cols-5 h-16 px-2 py-2 gap-1">
          ...
          >
            ...
            <p className={`text-xs ${isActive('/muro') ? 'font-bold' : 'font-medium'}`}>Muro</p>
          </button>
          ...
          >
            ...
            <p className={`text-xs ${isActive('/') && !isActive('/desafios') ? 'font-bold' : 'font-medium'}`}>Catálogo</p>
          </button>
          ...
          <button className="flex flex-col items-center justify-center gap-0.5 text-slate-600 hover:text-slate-900 hover:bg-[#FF8000]/5 rounded-full transition-all duration-200">
