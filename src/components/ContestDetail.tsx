...
export function ContestDetail() {
  ...
  // Mock data del concurso - En producción vendría de una API
  const contest = {
    id: 14,
    ...
    contestEndDate: '2026-03-25', // Nueva propiedad para el cálculo
    prizes: [
      ...
      <div className="max-w-4xl mx-auto w-full px-4 md:px-6 py-6 md:py-8">
        ...
        <div className="bg-white rounded-2xl md:rounded-3xl overflow-hidden shadow-lg shadow-slate-200/50">
          ...
          <div className="p-6 md:p-8">
            ...
            {/* CTA Button */}
            <div className="bg-gradient-to-r from-[#FF8000] to-[#FF9119] rounded-2xl p-8 text-center">
              <h3 className="text-2xl font-bold text-white mb-3">¿Listo para participar?</h3>
              <p className="text-white/90 mb-6">Comparte tu plan de desarrollo profesional y compite por increíbles premios</p>
              <button className="bg-white text-[#FF8000] px-8 py-4 rounded-full font-bold text-lg hover:shadow-xl hover:scale-105 transition-all flex items-center gap-3 mx-auto">
                <Upload className="w-6 h-6" />
                <span>Subir mi plan</span>
              </button>
              <p className="text-white/70 text-sm mt-4">{contest.participants} participantes ya se registraron</p>
            </div>
          </div>
        </div>
      </div>
