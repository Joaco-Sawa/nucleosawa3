import { Search, Menu, ChevronDown, Sparkles, Tag } from 'lucide-react';
    ...
    >
      ...
      <div className="md:hidden px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          {/* Profile Photo */}
          {/* TEMPORALMENTE DESHABILITADO: Click para abrir drawer de perfil */}
          {/* Para reactivar: descomentar onClick={() => setProfileDrawerOpen(true)} */}
          <button
      ...
      <div className="md:hidden px-4 pb-0 bg-[#F5F8FB]">
